class opencontrail_ci::nexus_repository(
  $registry_ports = [5000],
  $vmoptions_filepath = hiera('opencontrail_ci::nexus_repository::vmoptions_filepath', '/usr/share/nexus3/bin/nexus.vmoptions'),
  $memory_xms = hiera('opencontrail_ci::nexus_repository::memory_xms', '4G'),
  $memory_xmx = hiera('opencontrail_ci::nexus_repository::memory_xmx', '4G'),
  $memory_mdms = hiera('opencontrail_ci::nexus_repository::memory_mdms', '17530M')
) {
  include '::gnupg'
